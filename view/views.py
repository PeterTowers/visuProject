        ...
        dbc.DropdownMenu(
            [dbc.DropdownMenuItem("Técnicas utilizadas", style={'font-size': 'medium'}),
             ...
             dbc.DropdownMenuItem("Redução de dimensionalidade TSNE - comorbidades",
                                   ...
                                   style={'font-size': 'medium'}),
             dbc.DropdownMenuItem("Redução de dimensionalidade PCA - renda",
                                    href="/reducao-dim-renda-pca",
                                    style={'font-size': 'medium'}),
             dbc.DropdownMenuItem("Redução de dimensionalidade PCA - comorbidades",
                                    href="/reducao-dim-comorb-pca",
                                    style={'font-size': 'medium'})],
